    ...
    >
      {user && (
        <div className="flex items-center border-b-[1px] border-dark pb-2">
          ...
          <div
            className="w-8 h-8 flex items-center justify-center text-dark hover:bg-slate-200 rounded-full transition-all duration-200 cursor-pointer active:bg-slate-300 drop-shadow-lg shadow-black dark:text-light dark:hover:bg-slate-500 dark:active:bg-slate-400 ml-auto"
            onClick={closeNavbar}
          >
            <FontAwesomeIcon
              icon={faAnglesLeft}
